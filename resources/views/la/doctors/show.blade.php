...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Doctors", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/doctors/'.$doctor->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Doctors", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.doctors.destroy', $doctor->id], 'method' => 'delete', 'style'=>'display:inline']) }}
