...
class DoctorsController extends Controller
{
	...
	public $listing_cols = ['id', 'hospital_id', 'name', 'spec', 'address', 'email', 'password', 'gender'];
	...
	public function store(Request $request)
	{
		if(Module::hasAccess("Doctors", "create")) {
			...
			$insert_id = Module::insert("Doctors", $request);
	...
	public function update(Request $request, $id)
	{
		if(Module::hasAccess("Doctors", "edit")) {
			...
			$insert_id = Module::updateRow("Doctors", $request, $id);
